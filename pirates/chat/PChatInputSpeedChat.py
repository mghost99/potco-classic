...
class PChatInputSpeedChat(DirectObject.DirectObject):
    ...
    def sendChatByMode(self, msgType, textId, questInt = 0, taskNum = 0, questFlag = 0):
        ...
        if msgType == GMCHAT:
            ...
            base.chatAssistant.sendAvatarOpenTypedChat(gmHandler.getPhrase(textId))
            return
    ...
    def handleStaticTextMsg(self, textId):
        ...
        elif textId == PLocalizer.EMOTE_VALENTINES:
            self.handleEmoteMsg(textId)
        else:
        ...
        if sendText:
            if emoteId == PLocalizer.EMOTE_VALENTINES:
                emoteId = random.choice([
                    ...
                    PLocalizer.EMOTE_VALENTINES_D,
                    PLocalizer.EMOTE_VALENTINES_E])
