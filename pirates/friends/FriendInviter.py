    ...
    def __init__(self, avId, avName, isPlayerInvite, quickYesNo = True):
        ...
        self.fsm = ClassicFSM.ClassicFSM('FriendInviter', [
            ...
            State.State('wentAway',
                        self.enterWentAway,
                        self.exitWentAway),
            State.State('alreadyFriends',
                        self.enterAlreadyFriends,
