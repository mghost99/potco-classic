...
class JewelryGUI(DirectFrame, StateData.StateData):
    ...
    def loadTabs(self):
        self.zone1Tab = DirectButton(parent = self._parent,
                                     ...
                                     extraArgs = [Zone1_Tab], pos = (-0.97, 0, 1.02)
                                     )
        self.zone1Tab.hide()
        ...
        self.zone2Tab = DirectButton(parent = self._parent,
                                     ...
                                     text_align = TextNode.ACenter,
                                     text_pos = (0, -0.015),
                                     command = self.setMode, extraArgs = [Zone2_Tab], pos = (-0.72, 0, 1.02)
                                     )
        self.zone2Tab.hide()
        ...
        self.zone3Tab = DirectButton(parent = self._parent,
                                     ...
                                     text_align = TextNode.ACenter,
                                     text_pos = (0, -0.015),
                                     command = self.setMode, extraArgs = [Zone3_Tab], pos = (-0.47, 0, 1.02)
                                     )
        self.zone3Tab.hide()
        ...
        self.zone4Tab = DirectButton(parent = self._parent,
                                     ...
                                     text_pos = (0, -0.015),
                                     command = self.setMode,
                                     extraArgs = [Zone4_Tab], pos = (-0.22, 0, 1.02)
                                     )
        self.zone4Tab.hide()
        ...
        self.zone6Tab = DirectButton(parent = self._parent,
                                     ...
                                     text_pos = (0, -0.015),
                                     command = self.setMode,
                                     extraArgs = [Zone6_Tab], pos = (0.28, 0, 1.02)
                                     )
        self.zone6Tab.hide()
        ...
        self.zone7Tab = DirectButton(parent = self._parent,
                                     ...
                                     text_pos = (0, -0.015),
                                     command = self.setMode,
                                     extraArgs = [Zone7_Tab], pos = (0.53, 0, 1.02)
                                     )
        self.zone7Tab.hide()
        ...
        self.zone8Tab = DirectButton(parent = self._parent,
                                     ...
                                     text_pos = (0, -0.015),
                                     command = self.setMode,
                                     extraArgs = [Zone8_Tab], pos = (0.78, 0, 1.02)
                                     )
        self.zone8Tab.hide()
    ...
    def setupButtons(self):
        self.zone1Frame = DirectFrame(parent = self._parent, relief = DGG.FLAT, pos = (0.0, 0, 0.7))
        ...
        self.zone2Frame = DirectFrame(parent = self._parent, relief = DGG.FLAT, pos = (0.0, 0, 0.7))
        ...
        self.zone3Frame = DirectFrame(parent = self._parent, relief = DGG.FLAT, pos = (0.0, 0, 0.7))
        ...
        self.zone4Frame = DirectFrame(parent = self._parent, relief = DGG.FLAT, pos = (0.0, 0, 0.7))
        ...
        self.zone5Frame = DirectFrame(parent = self._parent, relief = DGG.FLAT, pos = (0.0, 0, 0.7))
        ...
        self.zone6Frame = DirectFrame(parent = self._parent, relief = DGG.FLAT, pos = (0.0, 0, 0.7))
        ...
        self.zone7Frame = DirectFrame(parent = self._parent, relief = DGG.FLAT, pos = (0.0, 0, 0.7))
        ...
        self.zone8Frame = DirectFrame(parent = self._parent, relief = DGG.FLAT, pos = (0.0, 0, 0.7))
    ...
    def loadColorGUI(self):
        self.primaryColorFrame = DirectFrame(parent = self.zone1Frame,
                                             relief = None,
        ...
        for i in range(0, len(HumanDNA.jewelryColors)):
            ...
            self.primaryColorButtons.append(DirectButton(parent = self.primaryColorFrame,
                                                         relief = DGG.RAISED,
        ...
        self.secondaryColorFrame = DirectFrame(parent = self.zone1Frame,
                                               relief = None,
                                               image = self.main.charGui.find('**/chargui_frame01'),
                                               image_pos = (0, 0, -0.3),
                                               image_scale = (2.43, 1.6, 1.6),
                                               text = 'Secondary Color', text_fg = (1, 1, 1, 1),
                                               text_scale = 0.18,
                                               text_pos = (0, -0.05),
                                               pos = (0, 0, -1.4),
                                               scale = 0.7
        ...
        for i in range(0, len(HumanDNA.jewelryColors)):
            ...
            self.secondaryColorButtons.append(DirectButton(parent = self.secondaryColorFrame,
                                                           relief = DGG.RAISED,
                                                           pos = (xOffset, 0, yOffset),
                                                           frameSize = (-0.1, 0.1, -0.1, 0.1),
                                                           borderWidth = (0.008, 0.008),
