...
shirt_styles = [
    ...
    'S_short_sleeve_vneck_closed',
    'S_short_sleeve_vneck_open',
    'S_long_sleeve_lowcut_puffy',
    'S_long_sleeve_lowcut_puffy_tuck',
    'S_long_sleeve_vneck_closed',
    'S_long_sleeve_vneck_open']
vector_tattoos = [
    [
        0,
        0.127,
...
ControlShapes = {
  'headWidth': [
    [
      ['def_trs_left_forehead', TX, 0.224, 0, 0, 0],
      ['def_trs_right_forehead', TX, -0.224, 0, 0, 0]
    ],
    [
      ['def_trs_left_forehead', TX, 0.224, 0, 0, 0],
      ['def_trs_right_forehead', TX, -0.224, 0, 0, 0]
  ...
  'headHeight': [
    [
      ['def_trs_forehead', TZ, 0.663, 0, 0, 0],
      ['def_trs_left_forehead', TZ, 0.569, 0, 0, 0],
      ['def_trs_right_forehead', TZ, 0.569, 0, 0, 0]
    ],
    [
      ['def_trs_forehead', TZ, 0.663, 0, 0, 0],
      ['def_trs_left_forehead', TZ, 0.569, 0, 0, 0],
  ...
  'headRoundness': [
    [
      ['def_trs_forehead', TZ, 0.608, 0, 0, 0],
      ['def_trs_left_forehead', TZ, 0.574, 0, 0, 0],
      ['def_trs_right_forehead', TZ, 0.574, 0, 0, 0],
      ['def_trs_mid_jaw', TZ, -0.176, 0, 0, 0],
      ['def_trs_mid_jaw', TY, -0.288, 0, 0, 0]
    ]
  ],
  'jawWidth': [
    [
      ['def_trs_left_jaw2', TX, 0.218, 0, 0, 0],
      ['def_trs_right_jaw2', TX, -0.218, 0, 0, 0]
    ],
    [
      ['def_trs_left_jaw2', TX, 0.218, 0, 0, 0],
      ['def_trs_right_jaw2', TX, -0.218, 0, 0, 0]
  ...
  'jawChinAngle': [
    [
      ['def_trs_left_jaw1', TY, -0.234, 0, 0, 0],
      ['def_trs_right_jaw1', TY, -0.234, 0, 0, 0],
      ['def_trs_mid_jaw', TY, -0.313, 0, 0, 0]
    ],
    [
      ['def_trs_left_jaw1', TY, -0.234, 0, 0, 0],
      ['def_trs_right_jaw1', TY, -0.234, 0, 0, 0],
  ...
  'jawChinSize': [
    [
      ['def_trs_left_jaw1', TX, 0.114, 0, 0, 0],
      ['def_trs_left_jaw1', TY, -0.209, 0, 0, 0],
      ['def_trs_left_jaw1', TZ, -0.118, 0, 0, 0],
      ['def_trs_right_jaw1', TX, -0.114, 0, 0, 0],
      ['def_trs_right_jaw1', TY, -0.209, 0, 0, 0],
      ['def_trs_right_jaw1', TZ, -0.118, 0, 0, 0],
      ['def_trs_mid_jaw', TZ, -0.201, 0, 0, 0]
    ],
    [
      ['def_trs_left_jaw1', TX, 0.114, 0, 0, 0],
      ['def_trs_left_jaw1', TY, -0.209, 0, 0, 0],
  ...
  'mouthWidth': [
    [
      ['trs_lips_top', SX, 1.2, 0, 0, 0],
      ['trs_lips_bot', SX, 1.2, 0, 0, 0]
    ]
  ],
  'mouthLipThickness': [
    [
      ['trs_lip_top', SZ, 1.2, 0, 0, 0],
      ['trs_lip_bot', SZ, 1.2, 0, 0, 0],
      ['trs_lip_left1', SZ, 1.2, 0, 0, 0],
      ['trs_lip_right1', SZ, 1.2, 0, 0, 0],
      ['trs_lip_left2', SZ, 1.2, 0, 0, 0],
      ['trs_lip_right2', SZ, 1.2, 0, 0, 0],
      ['trs_lip_left3', SZ, 1.2, 0, 0, 0],
      ['trs_lip_right3', SZ, 1.2, 0, 0, 0]
    ],
    [
      ['trs_lip_top', SZ, 1.2, 0, 0, 0],
      ['trs_lip_bot', SZ, 1.2, 0, 0, 0],
  ...
  'cheekFat': [
    [
      ['def_trs_left_cheek', TX, 0.216, 0, 0, 0],
      ['def_trs_right_cheek', TX, -0.216, 0, 0, 0]
    ],
    [
      ['def_trs_left_cheek', TX, 0.216, 0, 0, 0],
      ['def_trs_right_cheek', TX, -0.216, 0, 0, 0]
  ...
  'browProtruding': [
    [
      ['trs_left_eyebrow', TY, -0.05, 0, 0, 0],
      ['trs_right_eyebrow', TY, 0.05, 0, 0, 0]
    ]
  ],
  'eyeCorner': [
    [
  ...
  'eyeOpeningSize': [
    [
      ['trs_left_eyesocket', SX, 1.1, 0, 0, 0],
      ['trs_left_eyesocket', SZ, 1.1, 0, 0, 0],
      ['trs_right_eyesocket', SX, 1.1, 0, 0, 0],
      ['trs_right_eyesocket', SZ, 1.1, 0, 0, 0]
    ],
    [
      ['trs_left_eyesocket', SX, 1.1, 0, 0, 0],
      ['trs_left_eyesocket', SZ, 1.1, 0, 0, 0],
  ...
  'eyeSpacing': [
    [
      ['trs_left_eyesocket', TX, 0.008, 0, 0, 0],
      ['trs_right_eyesocket', TX, -0.008, 0, 0, 0]
    ],
    [
      ['trs_left_eyesocket', TX, 0.008, 0, 0, 0],
      ['trs_right_eyesocket', TX, -0.008, 0, 0, 0]
  ...
  'noseBridgeWidth': [
    [
      ['def_trs_mid_nose_top', SX, 1.25, 0, 0, 0]
    ],
    [
      ['def_trs_mid_nose_top', SX, 1.25, 0, 0, 0]
    ]
  ...
  'noseNostrilWidth': [
    [
      ['def_trs_mid_nose_bot', SX, 1.2, 0, 0, 0]
    ],
    [
      ['def_trs_mid_nose_bot', SX, 1.2, 0, 0, 0]
    ]
  ...
  'noseLength': [
    [
      ['def_trs_mid_nose_bot', TZ, 0.112, 0, 0, 0]
    ],
    [
      ['def_trs_mid_nose_bot', TZ, 0.112, 0, 0, 0]
    ]
  ...
  'noseBump': [
    [
      ['def_trs_mid_nose_top', TY, -0.442, 0, 0, 0],
      ['def_trs_mid_nose_top', TZ, 0.265, 0, 0, 0]
    ],
    [
      ['def_trs_mid_nose_top', TY, -0.442, 0, 0, 0],
      ['def_trs_mid_nose_top', TZ, 0.265, 0, 0, 0]
  ...
  'noseNostrilAngle': [
    [
      ['def_trs_mid_nose_bot', RY, 15, 0, 0, 0]
    ],
    [
      ['def_trs_mid_nose_bot', RY, 15, 0, 0, 0]
    ]
  ...
  'earScale': [
    [
      ['def_trs_left_ear', SZ, 1.1, 0, 0, 0],
      ['def_trs_right_ear', SZ, 1.1, 0, 0, 0],
      ['def_trs_left_ear', SX, 1.1, 0, 0, 0],
  ...
  'earFlap': [
    [
      ...
      ['def_trs_right_ear', RX, -160, 0, 0, 0]
    ],
    [
      ['def_trs_left_ear', RX, -20, 0, 0, 0],
      ['def_trs_right_ear', RX, -160, 0, 0, 0]
  ...
  'earPosition': [
    [
      ['def_trs_left_ear', TZ, 0.216, 0, 0, 0],
      ['def_trs_right_ear', TZ, 0.216, 0, 0, 0]
    ],
    [
      ['def_trs_left_ear', TZ, 0.216, 0, 0, 0],
      ['def_trs_right_ear', TZ, 0.216, 0, 0, 0]
...
class PirateMale(DirectObject.DirectObject):
    ...
    def handleHeadHiding(self):
        ...
        if self.texDict[texName[0]]:
            ...
            if self.pirate.optimizeLOD:
                for i in range(currentHat.getNumPaths() * 2 / 3, currentHat.getNumPaths()):
    ...
    def setupClothing(self, lodName = '2000'):
        ...
        layer3List = [
            ...
            '**/clothing_layer3_coat_india_navy*']
        if base.config.GetBool('want-gen-pics-buttons'):
            self.clothesByType = {
