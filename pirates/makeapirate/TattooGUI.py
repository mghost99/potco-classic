...
class TattooGUI(DirectFrame, StateData.StateData):
    ...
    def loadZone1GUI(self):
        ...
        self.editZone1 = DirectButton(parent = self.zone1FrameTitle,
                                      relief = DGG.RAISED,
                                      ...
                                      text_pos = (0, -0.025),
                                      command = self.setEdit,
                                      extraArgs = [Zone1_Tab],
                                      pos = (-0.8, 0, -1.0)
                                      )
        self.editZone2 = DirectButton(parent = self.zone2FrameTitle,
                                      relief = DGG.RAISED,
                                      frameSize = (-0.3, 0.3, -0.15, 0.15),
                                      borderWidth = (0.025, 0.025),
                                      text = 'Edit',
        ...
        self.editZone5 = DirectButton(parent = self.zone5FrameTitle,
                                      relief = DGG.RAISED,
                                      frameSize = (-0.3, 0.3, -0.15, 0.15),
                                      borderWidth = (0.025, 0.025),
                                      text = 'Edit',
    ...
    def setupButtons(self):
        self.guiNextTattooButton = DirectButton(parent = self.zone1Frame, relief = DGG.RAISED, pos = (0.3, 0.0, -0.5), scale = (2.0, 2.0, 2.0), command = self.handleNextTattoo, frameSize = (-0.09, 0.09, -0.05, 0.05), borderWidth = (0.008, 0.008), text = '>>', text_pos = (0, -0.015), text_scale = 0.1)
        self.guiLastTattooButton = DirectButton(parent = self.zone1Frame, relief = DGG.RAISED, pos = (-0.3, 0.0, -0.5), scale = (2.0, 2.0, 2.0), command = self.handleLastTattoo, frameSize = (-0.09, 0.09, -0.05, 0.05), borderWidth = (0.008, 0.008), text = '<<', text_pos = (0, -0.015), text_scale = 0.1)
    ...
    def updateCard(self):
        ...
        t = TransformState.makePosRotateScale2d(Vec2(tattoo[OFFSETX], tattoo[OFFSETY]), tattoo[ROTATE], Vec2(tattoo[SCALE], tattoo[SCALE]))
