...
class Eyes(DirectObject.DirectObject):
    ...
    def setupButtons(self):
        self.browFrame = DirectFrame(parent = self._parent, relief = None, text = PLocalizer.EyeBrowFrameTitle, text_fg = (1, 1, 1, 1), text_scale = 0.18, text_pos = (0, -0.05), pos = (0, 0, -0.1), scale = 0.7)
        self.browFrame.hide()
        self.eyeFrame = DirectFrame(parent = self._parent, relief = None, text = PLocalizer.EyeFrameTitle, text_fg = (1, 1, 1, 1), text_scale = 0.18, text_pos = (0, -0.05), pos = (0, 0, -1.1), scale = 0.7)
        self.eyeFrame.hide()
