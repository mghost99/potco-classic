...
class ClothesGUI(DirectFrame, StateData.StateData):
    ...
    def loadShirtGUI(self):
        self.clothesFrame = DirectFrame(parent = self._parent, relief = None, pos = (0, 0, 0), scale = 1)
        self.clothesFrame.hide()
        self.genPicsButtonsFrame = DirectFrame(parent = self.clothesFrame, relief = None, pos = (0, 0, 0), scale = 1)
        ...
        self.shirtGenPics = DirectButton(parent = self.genPicsButtonsFrame, relief = DGG.RAISED, frameSize = (-0.17, 0.17, -0.05, 0.05), borderWidth = (0.008, 0.008), text = PLocalizer.GeneratePictures, text_pos = (0, -0.015), text_scale = 0.08, pos = (-1, 0, 0.1), command = self.handleShirtGenPics)
        ...
        self.vestGenPics = DirectButton(parent = self.genPicsButtonsFrame, relief = DGG.RAISED, frameSize = (-0.17, 0.17, -0.05, 0.05), borderWidth = (0.008, 0.008), text = PLocalizer.GeneratePictures, text_pos = (0, -0.015), text_scale = 0.08, pos = (-1, 0, -0.3), command = self.handleVestGenPics)
        ...
        self.coatGenPics = DirectButton(parent = self.genPicsButtonsFrame, relief = DGG.RAISED, frameSize = (-0.17, 0.17, -0.05, 0.05), borderWidth = (0.008, 0.008), text = PLocalizer.GeneratePictures, text_pos = (0, -0.015), text_scale = 0.08, pos = (-1, 0, -0.7), command = self.handleCoatGenPics)
    ...
    def loadHatGUI(self):
        ...
        self.hatGenPics = DirectButton(parent = self.genPicsButtonsFrame, relief = DGG.RAISED, frameSize = (-0.17, 0.17, -0.05, 0.05), borderWidth = (0.008, 0.008), text = PLocalizer.GeneratePictures, text_pos = (0, -0.015), text_scale = 0.08, pos = (-1, 0, -1.1), command = self.handleHatGenPics)
    ...
    def loadPantGUI(self):
        ...
        self.pantGenPics = DirectButton(parent = self.genPicsButtonsFrame, relief = DGG.RAISED, frameSize = (-0.17, 0.17, -0.05, 0.05), borderWidth = (0.008, 0.008), text = PLocalizer.GeneratePictures, text_pos = (0, -0.015), text_scale = 0.08, pos = (-1, 0, -1.1), command = self.handlePantGenPics)
        ...
        self.beltGenPics = DirectButton(parent = self.genPicsButtonsFrame, relief = DGG.RAISED, frameSize = (-0.17, 0.17, -0.05, 0.05), borderWidth = (0.008, 0.008), text = PLocalizer.GeneratePictures, text_pos = (0, -0.015), text_scale = 0.08, pos = (-1, 0, -1.46), command = self.handleBeltGenPics)
    ...
    def loadShoeGUI(self):
        ...
        self.shoeGenPics = DirectButton(parent = self.genPicsButtonsFrame, relief = DGG.RAISED, frameSize = (-0.17, 0.17, -0.05, 0.05), borderWidth = (0.008, 0.008), text = PLocalizer.GeneratePictures, text_pos = (0, -0.015), text_scale = 0.08, pos = (-1, 0, -1.75), command = self.handleShoeGenPics)
    ...
    def loadTopColorGUI(self):
        ...
        def makeColorButtons(frame, colorButtons, colors, xOffset, yOffset, a, b):
            ...
            for i in range(lastTotal, lastTotal + len(colors[a:b])):
                ...
                colorButtons.append(DirectButton(parent = frame,
                                                 relief = DGG.RAISED,
        ...
        self.maleShirtColorFrameTitle = DirectFrame(parent = self.clothesFrame, relief = None, image = self.main.charGui.find('**/chargui_frame02'), image_scale = (1.1, 1, 1.2), image_pos = (0.3, 0, -0.1), scale = 0.8, pos = (0.35, 0, 0.15))
        ...
        self.maleVestColorFrameTitle = DirectFrame(parent = self.clothesFrame, relief = None, image = self.main.charGui.find('**/chargui_frame02'), image_scale = (1.1, 1, 1.2), image_pos = (0.3, 0, -0.1), scale = 0.8, pos = (0.35, 0, -0.25))
        ...
        self.maleCoatColorFrameTitle = DirectFrame(parent = self.clothesFrame, relief = None, image = self.main.charGui.find('**/chargui_frame02'), image_scale = (1.1, 1, 1.2), image_pos = (0.3, 0, -0.1), scale = 0.8, pos = (0.35, 0, -0.65))
        ...
        self.femaleShirtColorFrameTitle = DirectFrame(parent = self.clothesFrame, relief = None, image = self.main.charGui.find('**/chargui_frame02'), image_scale = (1.1, 1, 1.2), image_pos = (0.3, 0, -0.1), scale = 0.8, pos = (0.35, 0, 0.15))
        ...
        self.femaleVestColorFrameTitle = DirectFrame(parent = self.clothesFrame, relief = None, image = self.main.charGui.find('**/chargui_frame02'), image_scale = (1.1, 1, 1.2), image_pos = (0.3, 0, -0.1), scale = 0.8, pos = (0.35, 0, -0.25))
        ...
        self.femaleCoatColorFrameTitle = DirectFrame(parent = self.clothesFrame, relief = None, image = self.main.charGui.find('**/chargui_frame02'), image_scale = (1.1, 1, 1.2), image_pos = (0.3, 0, -0.1), scale = 0.8, pos = (0.35, 0, -0.65))
    ...
    def loadBotColorGUI(self):
        idx = 0
        self.maleBotColorFrameTitle = DirectFrame(parent = self.clothesFrame, relief = None, image = self.main.charGui.find('**/chargui_frame02'), image_scale = (1.1, 1, 1.2), image_pos = (0.3, 0, -0.1), scale = 0.8, pos = (0.35, 0, -1.05))
        ...
        for i in range(0, HumanDNA.ClothesMaxMAPColor):
            ...
            clothesTone = (clothesColor[0], clothesColor[1], clothesColor[2], 1.0)
            self.maleBotColorButtons.append(DirectButton(parent = self.maleBotColorFrameTitle,
                                                         relief = DGG.RAISED,
                                                         pos = (xOffset, 0, yOffset),
                                                         frameSize = (-0.1, 0.1, -0.1, 0.1),
                                                         borderWidth = (0.008, 0.008),
        ...
        idx = 1
        self.femaleBotColorFrameTitle = DirectFrame(parent = self.clothesFrame,
                                                    relief = None,
        ...
        for i in range(0, HumanDNA.ClothesMaxMAPColor):
            ...
            clothesColor = HumanDNA.clothesBotColors[idx][currTotal]
            clothesTone = (clothesColor[0], clothesColor[1], clothesColor[2], 1.0)
            self.femaleBotColorButtons.append(DirectButton(parent = self.femaleBotColorFrameTitle,
                                                           relief = DGG.RAISED,
                                                           pos = (xOffset, 0, yOffset),
                                                           frameSize = (-0.1, 0.1, -0.1, 0.1),
                                                           borderWidth = (0.008, 0.008),
    ...
    def handleSetTopColor(self, color):
        ...
        elif color >= topNumColor * 1 and color < topNumColor * 2:
            clothesTopColor[1] = color - topNumColor * 1
            for i in range(topNumColor * 1, topNumColor * 2):
                colorButtons[i]['relief'] = DGG.RAISED
            
            colorButtons[color]['relief'] = DGG.SUNKEN
        elif color >= topNumColor * 2 and color < topNumColor * 3:
    ...
    def handleClothingChanged(self):
        self.avatar.currentClothing['HAT'] = self.main.pirate.style.getClothesHat() + [
            self.main.pirate.style.getHatColor()]
        self.avatar.currentClothing['SHIRT'] = self.main.pirate.style.getClothesShirt() + [
            self.main.pirate.style.getClothesTopColor()[0]]
        self.avatar.currentClothing['VEST'] = self.main.pirate.style.getClothesVest() + [
            self.main.pirate.style.getClothesTopColor()[1]]
        self.avatar.currentClothing['COAT'] = self.main.pirate.style.getClothesCoat() + [
            self.main.pirate.style.getClothesTopColor()[2]]
        self.avatar.currentClothing['PANT'] = self.main.pirate.style.getClothesPant() + [
            self.main.pirate.style.getClothesBotColor()[0]]
        self.avatar.currentClothing['BELT'] = self.main.pirate.style.getClothesBelt() + [
            self.main.pirate.style.getClothesBotColor()[1]]
        self.avatar.currentClothing['SHOE'] = self.main.pirate.style.getClothesShoe() + [
