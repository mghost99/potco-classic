...
class HumanDNA(AvatarDNA.AvatarDNA):
    ...
    def getClothesSock(self):
        return [self.clothes.sock, self.clothes.sockTexture]
    ...
    def lookupHatColor(self):
        ...
        try:
            return hatColors[idx][self.color.hatColor]
        except:
            return hatColors[idx][0]
    ...
    def lookupClothesTopColor(self):
        ...
        try:
            return [
                clothesTopColors[idx][self.clothes.shirtColor],
                clothesTopColors[idx][self.clothes.vestColor],
                clothesTopColors[idx][self.clothes.coatColor]]
        except:
            return [
                clothesTopColors[idx][0],
                clothesTopColors[idx][5],
                clothesTopColors[idx][10]]
    ...
    def lookupClothesBotColor(self):
        ...
        try:
            return [
                clothesBotColors[idx][self.clothes.pantColor],
                clothesBotColors[idx][self.clothes.sashColor],
                clothesBotColors[idx][self.clothes.shoeColor]]
        except:
            return [
                clothesBotColors[idx][0],
                clothesBotColors[idx][7],
                clothesBotColors[idx][12]]
    ...
    def makeNPCNavySailor(self, seed = None, gender = 'm'):
        ...
        self.body.shape = randomGen.choice([
            ...
            3,
            4])
        self.body.height = 0.9 + randomGen.random() * 0.2
        self.body.headSize = 0.9 + randomGen.random() * 0.2
    ...
    def makeNetString(self):
        ...
        dg.addFloat64(self.head.texture)
        ...
        dg.addFloat64(self.head.eyes.color)
        ...
        dg.addUint8(self.clothes.hatColor)
        ...
        # Tattoo
        dg.addUint16(self.tattooChest[0])
        dg.addFloat64(self.tattooChest[1])
        dg.addFloat64(self.tattooChest[2])
        dg.addFloat64(self.tattooChest[3])
        dg.addFloat64(self.tattooChest[4])
        dg.addUint16(self.tattooChest[5])

        dg.addUint16(self.tattooZone2[0])
        dg.addFloat64(self.tattooZone2[1])
        dg.addFloat64(self.tattooZone2[2])
        dg.addFloat64(self.tattooZone2[3])
        dg.addFloat64(self.tattooZone2[4])
        dg.addUint16(self.tattooZone2[5])

        dg.addUint16(self.tattooZone3[0])
        dg.addFloat64(self.tattooZone3[1])
        dg.addFloat64(self.tattooZone3[2])
        dg.addFloat64(self.tattooZone3[3])
        dg.addFloat64(self.tattooZone3[4])
        dg.addUint16(self.tattooZone3[5])

        dg.addUint16(self.tattooZone4[0])
        dg.addFloat64(self.tattooZone4[1])
        dg.addFloat64(self.tattooZone4[2])
        dg.addFloat64(self.tattooZone4[3])
        dg.addFloat64(self.tattooZone4[4])
        dg.addUint16(self.tattooZone4[5])

        dg.addUint16(self.tattooZone5[0])
        dg.addFloat64(self.tattooZone5[1])
        dg.addFloat64(self.tattooZone5[2])
        dg.addFloat64(self.tattooZone5[3])
        dg.addFloat64(self.tattooZone5[4])
        dg.addUint16(self.tattooZone5[5])

        dg.addUint16(self.tattooZone6[0])
        dg.addFloat64(self.tattooZone6[1])
        dg.addFloat64(self.tattooZone6[2])
        dg.addFloat64(self.tattooZone6[3])
        dg.addFloat64(self.tattooZone6[4])
        dg.addUint16(self.tattooZone6[5])

        dg.addUint16(self.tattooZone7[0])
        dg.addFloat64(self.tattooZone7[1])
        dg.addFloat64(self.tattooZone7[2])
        dg.addFloat64(self.tattooZone7[3])
        dg.addFloat64(self.tattooZone7[4])
        dg.addUint16(self.tattooZone7[5])

        dg.addUint16(self.tattooZone8[0])
        dg.addFloat64(self.tattooZone8[1])
        dg.addFloat64(self.tattooZone8[2])
        dg.addFloat64(self.tattooZone8[3])
        dg.addFloat64(self.tattooZone8[4])
        dg.addUint16(self.tattooZone8[5])

        # Jewelry
        dg.addUint8(self.jewelryZone1[0])
        dg.addUint16(self.jewelryZone1[1])
        dg.addUint16(self.jewelryZone1[2])

        dg.addUint8(self.jewelryZone2[0])
        dg.addUint16(self.jewelryZone2[1])
        dg.addUint16(self.jewelryZone2[2])

        dg.addUint8(self.jewelryZone3[0])
        dg.addUint16(self.jewelryZone3[1])
        dg.addUint16(self.jewelryZone3[2])

        dg.addUint8(self.jewelryZone4[0])
        dg.addUint16(self.jewelryZone4[1])
        dg.addUint16(self.jewelryZone4[2])

        dg.addUint8(self.jewelryZone5[0])
        dg.addUint16(self.jewelryZone5[1])
        dg.addUint16(self.jewelryZone5[2])

        dg.addUint8(self.jewelryZone6[0])
        dg.addUint16(self.jewelryZone6[1])
        dg.addUint16(self.jewelryZone6[2])

        dg.addUint8(self.jewelryZone7[0])
        dg.addUint16(self.jewelryZone7[1])
        dg.addUint16(self.jewelryZone7[2])

        dg.addUint8(self.jewelryZone8[0])
        dg.addUint16(self.jewelryZone8[1])
        dg.addUint16(self.jewelryZone8[2])
    ...
    def makeFromNetString(self, netString):
        ...
        self.setHeadTexture(dgi.getFloat64())
        ...
        self.setEyesColor(dgi.getFloat64())
        ...
        # Tattoo
        self.setTattooChest(dgi.getUint16(), dgi.getFloat64(), dgi.getFloat64(), dgi.getFloat64(), dgi.getFloat64(), dgi.getUint16())
        self.setTattooZone2(dgi.getUint16(), dgi.getFloat64(), dgi.getFloat64(), dgi.getFloat64(), dgi.getFloat64(), dgi.getUint16())
        self.setTattooZone3(dgi.getUint16(), dgi.getFloat64(), dgi.getFloat64(), dgi.getFloat64(), dgi.getFloat64(), dgi.getUint16())
        self.setTattooZone4(dgi.getUint16(), dgi.getFloat64(), dgi.getFloat64(), dgi.getFloat64(), dgi.getFloat64(), dgi.getUint16())
        self.setTattooZone5(dgi.getUint16(), dgi.getFloat64(), dgi.getFloat64(), dgi.getFloat64(), dgi.getFloat64(), dgi.getUint16())
        self.setTattooZone6(dgi.getUint16(), dgi.getFloat64(), dgi.getFloat64(), dgi.getFloat64(), dgi.getFloat64(), dgi.getUint16())
        self.setTattooZone7(dgi.getUint16(), dgi.getFloat64(), dgi.getFloat64(), dgi.getFloat64(), dgi.getFloat64(), dgi.getUint16())
        self.setTattooZone8(dgi.getUint16(), dgi.getFloat64(), dgi.getFloat64(), dgi.getFloat64(), dgi.getFloat64(), dgi.getUint16())

        # Jewelry
        self.setJewelryZone1(dgi.getUint8(), dgi.getUint16(), dgi.getUint16())
        self.setJewelryZone2(dgi.getUint8(), dgi.getUint16(), dgi.getUint16())
        self.setJewelryZone3(dgi.getUint8(), dgi.getUint16(), dgi.getUint16())
        self.setJewelryZone4(dgi.getUint8(), dgi.getUint16(), dgi.getUint16())
        self.setJewelryZone5(dgi.getUint8(), dgi.getUint16(), dgi.getUint16())
        self.setJewelryZone6(dgi.getUint8(), dgi.getUint16(), dgi.getUint16())
        self.setJewelryZone7(dgi.getUint8(), dgi.getUint16(), dgi.getUint16())
        self.setJewelryZone8(dgi.getUint8(), dgi.getUint16(), dgi.getUint16())
