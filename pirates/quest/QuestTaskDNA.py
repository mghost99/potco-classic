    ...
    def getDescriptionText(self, state):
        ...
        if state.goal == 1:
            ...
            if shipType:
                ...
                return PLocalizer.DefeatShipTaskDescP % {
                    'num': state.goal}
        else:
            faction = PLocalizer.FactionShipTypeNames[self.faction.getFaction()][1][1]
            if shipType:
...
RecoverItemClasses = (RecoverAvatarItemTaskDNA, RecoverTreasureItemTaskDNA, RecoverShipItemTaskDNA, RecoverContainerItemTaskDNA, RecoverAvatarGroupItemTaskDNA)
