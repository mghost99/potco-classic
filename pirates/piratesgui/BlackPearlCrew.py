...
class BlackPearlCrew(DirectFrame):
    ...
    def __init__(self):
        ...
        self.hendryButton = GuiButton(parent = self, pos = (self.posX, self.posY, self.posZ), state = DGG.DISABLED, image = self.hendry, geom_pos = (self.posX, self.posY, self.posZ), helpText = PLocalizer.HendryName, helpDelay = PiratesGuiGlobals.HelpPopupTime, helpPos = (0.1, 0, 0.65))
        ...
        self.leCerdoButton = GuiButton(parent = self, pos = (self.posX, self.posY, self.posZ), state = DGG.DISABLED, image = self.leCerdo, geom_pos = (self.posX, self.posY, self.posZ), helpText = PLocalizer.LeCerdoName, helpDelay = PiratesGuiGlobals.HelpPopupTime, helpPos = (0.2, 0, 0.55))
        ...
        self.gunnerButton = GuiButton(parent = self, pos = (self.posX, self.posY, self.posZ), state = DGG.DISABLED, image = self.gunner, geom_pos = (self.posX, self.posY, self.posZ), helpText = PLocalizer.GunnerName, helpDelay = PiratesGuiGlobals.HelpPopupTime, helpPos = (0.65, 0, 0.6))
        ...
        self.gordonButton = GuiButton(parent = self, pos = (self.posX, self.posY, self.posZ), state = DGG.DISABLED, image = self.greer, geom_pos = (self.posX, self.posY, self.posZ), helpText = PLocalizer.GordonName, helpDelay = PiratesGuiGlobals.HelpPopupTime, helpPos = (0.95, 0, 0.55))
        ...
        self.johnButton = GuiButton(parent = self, pos = (self.posX, self.posY, self.posZ), state = DGG.DISABLED, image = self.john, geom_pos = (self.posX, self.posY, self.posZ), helpText = PLocalizer.JohnName, helpDelay = PiratesGuiGlobals.HelpPopupTime, helpPos = (0.45, 0, 0.6))
        ...
        self.nillButton = GuiButton(parent = self, pos = (self.posX, self.posY, self.posZ), state = DGG.DISABLED, image = self.nill, geom_pos = (self.posX, self.posY, self.posZ), helpText = PLocalizer.NillName, helpDelay = PiratesGuiGlobals.HelpPopupTime, helpPos = (0.85, 0, 0.2))
        ...
        self.scaryMaryButton = GuiButton(parent = self, pos = (self.posX, self.posY, self.posZ), state = DGG.DISABLED, image = self.scaryMary, geom_pos = (self.posX, self.posY, self.posZ), helpText = PLocalizer.ScaryMaryName, helpDelay = PiratesGuiGlobals.HelpPopupTime, helpPos = (0.7, 0, 0.1))
        ...
        self.giladogaButton = GuiButton(parent = self, pos = (self.posX, self.posY, self.posZ), state = DGG.DISABLED, image = self.giladoga, geom_pos = (self.posX, self.posY, self.posZ), helpText = PLocalizer.GiladogaName, helpDelay = PiratesGuiGlobals.HelpPopupTime, helpPos = (0.15, 0, 0.1))
