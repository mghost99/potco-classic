...
class CrewIconSelector(GuiPanel.GuiPanel):
    ...
    def loadIconList(self):
        ...
        for (loopItr, iconFile) in CREW_ICONS.items():
            ...
            self.setPics[setKey] = DirectButton(parent = self.iconFrame, relief = None, image = tex, image_scale = 0.34, image2_scale = 0.36, image_pos = (0, 0, 0), pos = (0.24 + 0.18 * rowSpot, 0, self.localHeight - 0.4 - 0.18 * colSpot - 0.18), command = self.__setIconKey, extraArgs = [
