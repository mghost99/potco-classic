...
buffTable = {
    ...
    WeaponGlobals.C_HASTEN: ('buff_hasten', PLocalizer.BuffHasten),
...
class BuffIcon(DirectFrame):
    ...
    def makeDetails(self):
        ...
        self.detailBox = DirectLabel(state = DGG.DISABLED, relief = None, text = text, text_align = TextNode.ALeft, text_scale = 0.03, text_fg = (1, 1, 1, 1), text_wordwrap = 15, text_shadow = (0, 0, 0, 1), textMayChange = 1)
