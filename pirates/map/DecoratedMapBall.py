...
class DecoratedMapBall(MapBall):
    ...
    def initGlobalStencil(self):
        globalStencilAttrib = StencilAttrib.make(1, StencilAttrib.SCFAlways, StencilAttrib.SOKeep, StencilAttrib.SOKeep, StencilAttrib.SOReplace, 255, 0xFFFFFFFF, 0xFFFFFFFF)
    ...
    def placeShip(self, shipInfo, worldPos):
    ...
    def placeIsland(self, name, islandUid, modelPath, worldPos, rotation):
        ...
        if not name:
            ...
            info = (DecorTypes.TextIsland, (name, islandUid, modelPath, isTeleportable, self.cam, 0.001, scale), {'pos': worldPos, 'rot': rotation})
        self.addAndPlaceItem(name, info)
    ...
    def setDecorInfo(self):
        if __dev__ and 0:
            ...
            self.decorInfo = {
              ...
              'smiley': (DecorTypes.Model, ('smiley', 'models/misc/smiley', 0.005), {
                'pos': Point2(0)
              })
            }
        else:
