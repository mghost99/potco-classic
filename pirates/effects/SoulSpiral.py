...
class SoulSpiral(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        self.effectModel = loader.loadModelCopy('models/effects/soulspiral')
        self.effectModel2 = loader.loadModelCopy('models/effects/soulspiral')
        self.effectModel3 = loader.loadModelCopy('models/effects/soulspiral')
        self.effectModel4 = loader.loadModelCopy('models/effects/soulspiral')
