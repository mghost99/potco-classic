...
class SteamEffect(PooledEffect, EffectController):
    ...
    def createTrack(self, lod = Options.SpecialEffectsHigh):
        ...
        self.p0.renderer.getColorInterpolationManager().addLinear(0.75, 1.0, Vec4(1.0, 1.0, 1.0, 1.0), Vec4(1.0, 1.0, 1.0, 0.0), 1)
        self.p0.emitter.setEmissionType(BaseParticleEmitter.ETRADIATE)
        self.p0.emitter.setAmplitude(1.0)
        self.p0.emitter.setAmplitudeSpread(0.0)
        self.p0.emitter.setOffsetForce(Vec3(0.0, -4.5, 7.0))
