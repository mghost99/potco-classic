...
class Sparkles(PooledEffect, EffectController):
    ...
    def createTrack(self):
        self.startEffect = Sequence(Func(self.p0.setBirthRate, 0.02), Func(self.p0.clearToInitial), Func(self.f.start, self, self), Wait(0.25), Func(self.p0.setBirthRate, 0.04))
    ...
    def setEffectScale(self, scale):
        ...
        self.p0.emitter.setAmplitude(40.0 * scale)
