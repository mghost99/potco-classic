...
class MuzzleFlame(PooledEffect, EffectController):
    ...
    def __init__(self):
        ...
        force0 = LinearFrictionForce(1.0, 5.0, 1.0)
        force0.setActive(1)
        f0.addForce(force0)
    ...
    def createTrack(self):
        ...
        self.p0.renderer.setInitialXScale(0.12 * self.cardScale)
        self.p0.renderer.setFinalXScale(0.08 * self.cardScale)
        self.p0.renderer.setInitialYScale(0.12 * self.cardScale)
        self.p0.renderer.setFinalYScale(0.08 * self.cardScale)
        self.p0.renderer.setNonanimatedTheta(0.0)
        self.p0.renderer.setAlphaBlendMethod(BaseParticleRenderer.PPNOBLEND)
        self.p0.renderer.setAlphaDisable(0)
        self.p0.emitter.setEmissionType(BaseParticleEmitter.ETRADIATE)
        self.p0.emitter.setAmplitude(15.0)
        self.p0.emitter.setAmplitudeSpread(15.0)
        self.p0.emitter.setOffsetForce(Vec3(0.0, 55.0, 0.0))
