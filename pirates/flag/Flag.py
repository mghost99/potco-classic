...
class Flag(NodePath):
    ...
    def __init__(self, name):
        ...
        self.shapeNode = loader.loadModelCopy('models/flags/flag_shape')
        self.bgNode = loader.loadModelCopy('models/flags/flag_bg')
        self.emblemNode = loader.loadModelCopy('models/flags/flag_emblem')
