...
__hullStats = {
  WARSHIPL1: {
    'maxHp': 4200,
    'maxArrayHp': [1000, 600, 600, 450, 450, 300, 300, 450, 450],
    'maxSp': 900,
    'maxCargo': 5,
    'maxCrew': 8,
    'maxCannons': 8,
    'maxBroadsides': 10,
    'rammingPower': 450,
    'acceleration': 0.7 * defaultAcceleration,
    ...
    'mass': 100.0,
    'waterIntakeDrag': 1.0 * defaultWaterIntake,
    'sphereRadius': 30.0
  },
  WARSHIPL2: {
    'maxHp': 8400,
    'maxArrayHp': [1500, 1200, 1200, 1150, 1150, 900, 900, 1150, 1150],
    'maxSp': 1400,
    'maxCargo': 9,
    'maxCrew': 10,
    'maxCannons': 10,
  ...
  WARSHIPL3: {
    'maxHp': 12600,
    'maxArrayHp': [2500, 1800, 1800, 1500, 1500, 1200, 1200, 1500, 1500],
    'maxSp': 2400,
    'maxCargo': 12,
    'maxCrew': 12,
    'maxCannons': 14,
  ...
  MERCHANTL1: {
    'maxHp': 3600,
    'maxArrayHp': [1400, 300, 300, 450, 450, 750, 750],
    'maxSp': 1100,
    'maxCargo': 7,
    'maxCrew': 6,
    'maxCannons': 4,
    'maxBroadsides': 10,
    'rammingPower': 300,
    'acceleration': 0.6 * defaultAcceleration,
    'maxSpeed': 0.6 * defaultMaxSpeed,
  ...
  MERCHANTL2: {
    'maxHp': 7200,
    'maxArrayHp': [2000, 600, 600, 750, 750, 1050, 1050],
    'maxSp': 1400,
    'maxCargo': 11,
    'maxCrew': 8,
    'maxCannons': 8,
  ...
  MERCHANTL3: {
    'maxHp': 10800,
    'maxArrayHp': [3200, 1200, 1200, 1350, 1350, 1650, 1650],
    'maxSp': 3100,
    'maxCargo': 16,
    'maxCrew': 10,
    'maxCannons': 10,
  ...
  INTERCEPTORL1: {
    'maxHp': 2400,
    'maxArrayHp': [800, 450, 450, 600, 600, 450, 450],
    'maxSp': 800,
    'maxCargo': 3,
    'maxCrew': 3,
    'maxCannons': 2,
    'maxBroadsides': 6,
    'rammingPower': 150,
    'acceleration': 0.8 * defaultAcceleration,
  ...
  INTERCEPTORL2: {
    'maxHp': 4800,
    'maxArrayHp': [1200, 600, 600, 900, 900, 600, 600],
    'maxSp': 800,
    'maxCargo': 6,
    'maxCrew': 6,
    'maxCannons': 6,
  ...
  INTERCEPTORL3: {
    'maxHp': 7200,
    'maxArrayHp': [2000, 1050, 1050, 1500, 1500, 1050, 1050],
    'maxSp': 1000,
    'maxCargo': 9,
    'maxCrew': 9,
    'maxCannons': 8,
  ...
  BLACK_PEARL: {
    'maxHp': 12000,
    'maxArrayHp': [2400, 1800, 1800, 1500, 1500, 1200, 1200, 1500, 1500],
    'maxSp': 0,
    'maxCargo': 18,
    'maxCrew': 12,
    'maxCannons': 14,
  ...
  GOLIATH: {
    'maxHp': 3500,
    'maxArrayHp': [3000, 1800, 1800, 1500, 1500, 1200, 1200, 1500, 1500],
    'maxSp': 0,
    'maxCargo': 3,
    'maxCrew': 8,
    'maxCannons': 18,
  ...
  NAVY_PANTHER: {
    ...
    'maxBroadsides': 10,
    'rammingPower': 150,
    'acceleration': 0.9 * defaultAcceleration,
    'maxSpeed': 0.9 * defaultMaxSpeed,
    'reverseAcceleration': 0.9 * defaultReverseAcceleration,
    'maxReverseSpeed': 0.9 * defaultMaxReverseAcceleration,
  ...
  NAVY_CENTURION: {
    'maxHp': 2100,
    'maxArrayHp': [2200, 1200, 1200, 1050, 1050, 900, 900, 1050, 1050],
    'maxSp': 0,
    'maxCargo': 3,
    'maxCrew': 6,
    'maxCannons': 10,
  ...
  NAVY_MAN_O_WAR: {
    'maxHp': 2100,
    'maxArrayHp': [3100, 1800, 1800, 1500, 1500, 1200, 1200, 1500, 1500],
    'maxSp': 0,
    'maxCargo': 3,
    'maxCrew': 8,
    'maxCannons': 14,
    ...
    'reverseAcceleration': 0.8 * defaultReverseAcceleration,
    'maxReverseSpeed': 0.8 * defaultMaxReverseAcceleration,
    'turn': 0.3 * defaultTurn,
    'maxTurn': 0.3 * defaultMaxTurn,
    'mass': 100.0,
    'waterIntakeDrag': 1.0 * defaultWaterIntake,
    'sphereRadius': 30.0
  },
  ...
  NAVY_FERRET: {
    ...
    'maxBroadsides': 6,
    'rammingPower': 75,
    'acceleration': 1.8 * defaultAcceleration,
    'maxSpeed': 1.8 * defaultMaxSpeed,
    'reverseAcceleration': 1.8 * defaultReverseAcceleration,
    'maxReverseSpeed': 1.8 * defaultMaxReverseAcceleration,
    'turn': 1.4 * defaultTurn,
    'maxTurn': 1.4 * defaultMaxTurn,
    'mass': 20.0,
    'waterIntakeDrag': 1.0 * defaultWaterIntake,
    'sphereRadius': 5.0
  },
  NAVY_GREYHOUND: {
    'maxHp': 1200,
    'maxArrayHp': [800, 450, 450, 900, 900, 450, 450],
    'maxSp': 0,
    'maxCargo': 2,
    'maxCrew': 8,
    'maxCannons': 6,
  ...
  SKEL_PHANTOM: {
    'maxHp': 2500,
    'maxArrayHp': [1300, 1200, 1200, 900, 900, 600, 600],
    'maxSp': 0,
    'maxCargo': 2,
    'maxCrew': 8,
    'maxCannons': 8,
  ...
  SKEL_SHADOW_CROW_FR: {
    'maxHp': 2500,
    'maxArrayHp': [1100, 1200, 1200, 900, 900, 600, 600],
    'maxSp': 0,
    'maxCargo': 1,
    'maxCrew': 8,
    'maxCannons': 6,
  ...
  SKEL_HELLHOUND_FR: {
    'maxHp': 3000,
    'maxArrayHp': [1500, 1500, 1500, 1100, 1100, 800, 800],
    'maxSp': 0,
    'maxCargo': 2,
    'maxCrew': 8,
    'maxCannons': 6,
  ...
  SKEL_BLOOD_SCOURGE_FR: {
    'maxHp': 4000,
    'maxArrayHp': [1900, 2000, 2000, 1500, 1500, 1000, 1000],
    'maxSp': 0,
    'maxCargo': 3,
    'maxCrew': 8,
    'maxCannons': 6,
...
__boardingSphere = {
  ...
  SKEL_INTERCEPTORL3: ((Vec3(11.899, -1.7117, 21.8932), -29), 45)
}
__exitSphere = {
  DINGHY: (0, 0, 0),
  ...
  WARSHIPL4: (21.26, 13.44, 21.93),
  MERCHANTL1: (-5.44, 6.735, 12.278),
  MERCHANTL2: (-5.44, 6.735, 12.278),
  MERCHANTL3: (-5.44, 6.735, 12.278),
  MERCHANTL4: (-5.44, 6.735, 12.278),
  INTERCEPTORL1: (2.354, -15.201, 5.493),
  INTERCEPTORL2: (2.354, -15.201, 5.493),
  INTERCEPTORL3: (2.354, -15.201, 5.493),
  INTERCEPTORL4: (2.354, -15.201, 5.493),
...
__shipLowLODPosOffset = {
  DINGHY: Vec3(0, 0, 0),
  WARSHIPL1: Vec3(0, 2, 2),
  WARSHIPL2: Vec3(0, -9, 4),
  WARSHIPL3: Vec3(0, -1, 1.3),
  WARSHIPL4: Vec3(0, 0, 0),
  MERCHANTL1: Vec3(0, 0, 0),
  MERCHANTL2: Vec3(0, 0, 0),
  MERCHANTL3: Vec3(0, 2, 6),
  MERCHANTL4: Vec3(0, 0, 0),
  INTERCEPTORL1: Vec3(0, 6, -3),
  INTERCEPTORL2: Vec3(0, 0, 0),
  INTERCEPTORL3: Vec3(0, 3, -3.2),
  INTERCEPTORL4: Vec3(0, 0, 0),
  BLACK_PEARL: Vec3(0, 0, 0),
  GOLIATH: Vec3(0, 0, 0),
  SKEL_WARSHIPL3: Vec3(0, 0, 0),
  SKEL_INTERCEPTORL3: Vec3(0, 0, 0)
}
...
__sailStats = {
  MAINSAILL1: {
    'maxHp': 900,
    'maxSp': 300,
    'acceleration': 0.05 * defaultAcceleration,
    'maxSpeed': 0.05 * defaultMaxSpeed,
    'reverseAcceleration': 0.05 * defaultReverseAcceleration,
    'maxReverseSpeed': 0.05 * defaultMaxReverseAcceleration,
    'turn': 0.05 * defaultTurn,
    'maxTurn': 0.05 * defaultMaxTurn,
    'mass': 0
  },
  FORESAILL1: {
    'maxHp': 600,
