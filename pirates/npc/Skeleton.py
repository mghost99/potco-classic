...
AvType2style = {
    ...
    AvatarTypes.EarthUndead[3]: '1',
    AvatarTypes.EarthUndead[4]: '2',
    AvatarTypes.EarthUndead[5]: '8',
    AvatarTypes.EarthUndead[6]: '1',
    AvatarTypes.EarthUndead[7]: '2',
    AvatarTypes.EarthUndead[8]: '8',
    AvatarTypes.EarthUndead[9]: '4',
    ...
    def getEnterDeathTrack(self):
        ...
        def startVFX():
            if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                ...
                if self.deathEffect:
                    self.deathEffect.reparentTo(self)
                    self.deathEffect.setPos(0.0, -5.0, 0.0)
                    self.deathEffect.effectScale = 1.0
                ...
                if self.shockwaveRingEffect:
                    self.shockwaveRingEffect.reparentTo(self)
                    self.shockwaveRingEffect.setPos(0.0, -5.0, 0.0)
                    self.shockwaveRingEffect.showThrough()
                    self.shockwaveRingEffect.size = 25.0
                ...
                if self.spiritEffect:
                    self.spiritEffect.reparentTo(self)
                    self.spiritEffect.setPos(0.0, -5.0, 6.2)
                    self.spiritEffect.wrtReparentTo(render)
                    self.spiritEffect.setScale(1.0)
