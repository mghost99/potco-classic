...
DoubleXPStart = makeHeadingString('Double Reputation Event In Progress!', 2) + '\nPlayers will earn double Reputation points for land and sea battles. %(hours)s Hours, %(minutes)s Minutes Minutes remain before the end of the event.'
DoubleXPEnd = 'The double reputation point event for all has just ended!'
DoubleXPFullStart = makeHeadingString('Double Reputation Event In Progress!', 2) + '\nAll Unlimited Access Members will receive double Reputation points for all land and sea battles. %(hours)s Hours, %(minutes)s Minutes remain before the end of the event.'
DoubleXPFullEnd = 'The double reputation point event for unlimited access members has just ended!'
DoubleXPStartChat = 'Double Reputation Event In Progress!\nPlayers will earn double reputation points for land and sea battles. %(hours)s Hours, %(minutes)s Minutes remain before the end of the event.'
...
HalfOffCustomizationStart = 'Half off customization for Unlimited Access players: %(hours)s Hours, %(minutes)s minutes'
...
AllAccessHolidayStart = 'Free Preview Weekend for the next %(hours)s Hours, %(minutes)s minutes'
UnlimitedAccessEventBasic = "Avast! It's a Free Preview Weekend! Your Basic Access account has been upgraded to Unlimited Access for FREE until noon (PDT), August 18. %(hours)s Hours, %(minutes)s Minute(s) until the end of the event."
UnlimitedAccessEventUnlimited = "Avast! It's a Free Preview Weekend for Limited Access crew members. Please feel free to invite friends and family to signup for a free account. They will be able to experience being an Unlimited Access crew member from now until noon (PDT), August 18th. %(hours)s Hours, %(minutes)s Minute(s) until the end of the event."
UnlimitedAccessEventUnlimitedChat = "Avast! It's a Free Preview Weekend for Limited Access crew members. Please feel free to invite friends and family to signup for a free account. Now until noon (PDT), August 18th. %(hours)s Hours, %(minutes)s Minute(s) until the end of the event."
