...
class UserFunnel:
    ...
    def whatOSver(self):
        if sys.platform == 'win32':
            ...
            self.osMajorver = '10'
            osxcmd = 'system_profiler SPSoftwareDataType |grep "System Version"'
...
def getMAC(staticMAC = [None]):
    if staticMAC[0] == None:
        if sys.platform == 'win32':
            ...
            macconfdata = os.popen('system_profiler SPNetworkDataType |grep MAC').readlines()
            ...
            if macconfdata[0].find('HWaddr') != -1:
