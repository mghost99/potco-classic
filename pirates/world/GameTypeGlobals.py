...
GameTypeStrings = {
    ...
    'icon': {
        ...
        PiratesGlobals.GAME_TYPE_CREW: 'lookout_win_friend_icon',
...
GameTypes = {
    PiratesGlobals.GAME_TYPE_CREW: {
        'style': {
            PiratesGlobals.CREW_STYLE_FIND_A_CREW: {
                'options': {
                    'execute': 'find'}},
            PiratesGlobals.CREW_STYLE_FIND_A_PVP_CREW: {
                'options': {
                    'execute': 'findPvp'}},
            PiratesGlobals.CREW_STYLE_RECRUIT_MEMBERS: {
                'options': {
                    'execute': 'recruit'}}}},
...
def gameTypeAccessable(gameCat, gameType, gameAccess):
    if gameAccess == OTPGlobals.AccessFull or gameAccess == OTPGlobals.AccessUnknown:
        return True
    elif gameCat == PiratesGlobals.GAME_TYPE_PVP and gameType == PiratesGlobals.GAME_STYLE_BATTLE or gameCat == PiratesGlobals.GAME_TYPE_PG and gameType == PiratesGlobals.GAME_STYLE_BLACKJACK:
        return True
    return False
