...
class TimeOfDayPanel(AppShell):
    ...
    def createInterface(self):
        ...
        self.fogColor = Valuator.ValuatorGroup(parent = fogFrame, dim = 3, labels = [
            'R',
            'G',
            'B'], value = [
            int(initialFogColor[0] * 255),
            int(initialFogColor[1] * 255),
            int(initialFogColor[2] * 255)], type = 'slider', valuator_style = 'full', valuator_min = 0, valuator_max = 255, valuator_resolution = 1)
        ...
        self.ambientLabel = Label(ambientFrame, text = 'AMBIENT LIGHT', font = ('MS Sans Serif', 14))
        self.ambientLabel['bg'] = self.getTkColorFromVec4(initialAmbientColor)
        self.ambientColor = Valuator.ValuatorGroup(parent = ambientFrame, dim = 3, labels = [
            'R',
            'G',
            'B'], value = [
            int(initialAmbientColor[0] * 255),
            int(initialAmbientColor[1] * 255),
            int(initialAmbientColor[2] * 255)], type = 'slider', valuator_style = 'full', valuator_min = 0, valuator_max = 255, valuator_resolution = 1)
        ...
        self.directionalLabel = Label(directionalFrame, text = 'DIRECTIONAL LIGHT', font = ('MS Sans Serif', 14))
        self.directionalLabel['bg'] = self.getTkColorFromVec4(initialDirectionalColor)
        self.directionalColor = Valuator.ValuatorGroup(parent = directionalFrame, dim = 3, labels = [
            'R',
            'G',
            'B'], value = [
            int(initialDirectionalColor[0] * 255),
            int(initialDirectionalColor[1] * 255),
            int(initialDirectionalColor[2] * 255)], type = 'slider', valuator_style = 'full', valuator_min = 0, valuator_max = 255, valuator_resolution = 1)
