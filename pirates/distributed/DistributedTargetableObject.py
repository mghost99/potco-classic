...
class DistributedTargetableObject(DistributedNode.DistributedNode):
    ...
    def playOuch(self, skillId, ammoSkillId, targetEffects, attacker, pos, multihit = 0, targetBonus = 0):
        ...
        if not targetBonus and not self.NoPain and targetEffects[0] < 0:
            if self.gameFSM.state not in ('Ensnared', 'Knockdown', 'Stunned', 'Rooted', 'NPCInteract', 'ShipBoarding'):
                ouchSfx = None
    ...
    def targetedWeaponHit(self, skillId, ammoSkillId, skillResult, targetEffects, attacker, pos, charge = 0, delay = None, multihit = 0):
        ...
        elif skillResult == WeaponGlobals.RESULT_MISS or skillResult == WeaponGlobals.RESULT_DODGE or skillResult == WeaponGlobals.RESULT_PARRY or skillResult == WeaponGlobals.RESULT_RESIST:
        ...
        elif skillResult == WeaponGlobals.RESULT_OUT_OF_RANGE:
            pass
