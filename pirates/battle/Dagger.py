...
class Dagger(Weapon.Weapon):
    modelTypes = {
        InventoryType.DaggerWeaponL1: ('models/handheld/dagger_high', Vec4(1, 1, 1, 1)),
        InventoryType.DaggerWeaponL2: ('models/handheld/dagger_dirk_high', Vec4(1, 1, 1, 1)),
        InventoryType.DaggerWeaponL3: ('models/handheld/dagger_gauche_high', Vec4(1, 1, 1, 1)),
        InventoryType.DaggerWeaponL4: ('models/handheld/dagger_coltello_high', Vec4(1, 1, 1, 1)),
        InventoryType.DaggerWeaponL5: ('models/handheld/dagger_bloodletter_high', Vec4(1, 1, 1, 1)),
        InventoryType.DaggerWeaponL6: ('models/handheld/dagger_slicer_high', Vec4(1, 1, 1, 1))}
    models = {}
    icons = {}
    vertex_list = [
    ...
    def getDaggerThrowDirtInterval(self, av, skillId, ammoSkillId, charge, target):
        ...
        ival = Sequence(Func(self.lockInput, av),
                        ...
                        Func(self.hideMouse, av),
                        Func(base.disableMouse),
                        Func(self.endAttack, av),
                        Func(self.setTrailLength, 0.25),
                        Func(self.hideWeapon),
                        Func(self.beginAttack, av), av.actorInterval('dagger_throw_sand', playRate = 1.0, startFrame = 1, endFrame = 10, blendInT = 0.2, blendOutT = 0),
                        Func(self.playSkillSfx, skillId, av),
                        Func(startVFX), av.actorInterval('dagger_throw_sand', playRate = 1.0, startFrame = 11, endFrame = 38, blendInT = 0, blendOutT = 0.3),
                        Func(self.showWeapon),
    ...
    def setupSounds(cls):
        ...
        Dagger.hitSfxs = (loader.loadSfx('audio/sfx_dagger_impact.mp3'),)
        Dagger.skillSfxs = {
            InventoryType.DaggerCut: loader.loadSfx('audio/sfx_dagger_cut.mp3'),
            InventoryType.DaggerSwipe: loader.loadSfx('audio/sfx_dagger_swipe.mp3'),
            InventoryType.DaggerGouge: loader.loadSfx('audio/sfx_dagger_gouge.mp3'),
            InventoryType.DaggerEviscerate: loader.loadSfx('audio/sfx_dagger_eviscerate.mp3'),
            InventoryType.DaggerAsp: loader.loadSfx('audio/sfx_dagger_thrown.mp3'),
            InventoryType.DaggerAdder: loader.loadSfx('audio/sfx_dagger_poison.mp3'),
            InventoryType.DaggerThrowDirt: loader.loadSfx('audio/sfx_dagger_throw_dirt.mp3'),
            InventoryType.DaggerSidewinder: loader.loadSfx('audio/sfx_dagger_sidewinder.mp3'),
            InventoryType.DaggerViperNest: loader.loadSfx('audio/sfx_dagger_vipersnest.mp3')}
