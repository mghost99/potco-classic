...
class DiceGameGUI(DirectFrame):
    ...
    ArrowPosHpr = ((Vec3(-0.4, 0, 0.66), Vec3(0, 0, 90)), (Vec3(-0.82, 0, 0.33), Vec3(0, 0, 90)), (Vec3(-0.5, 0, -0.08), Vec3(0, 0, 90)), (Vec3(0, 0, -0.08), Vec3(0, 0, 90)), (Vec3(0.5, 0, -0.08), Vec3(0, 0, 90)), (Vec3(0.82, 0, 0.33), Vec3(0, 0, 90)), (Vec3(0.4, 0, 0.66), Vec3(0, 0, 90)))
    ...
    def __init__(self, table, numDice = 12, public_roll = 1, name = 'Dice Game'):
        ...
        self.finalPos = []
        self.lerpList = []
        self.gameLabel = DirectLabel(parent = self,
                                     relief = None,
                                     text = name,
        ...
        self.gameLabel.show()
        self.turnStatus = DirectLabel(parent = self,
                                      relief = None,
        ...
        self.gameStatus = DirectLabel(parent = self,
                                      relief = None,
                                      text = '',
                                      text_align = TextNode.ALeft,
                                      text_scale = 0.06,
        ...
        self.mainButton = DirectButton(parent = self.menu,
                                       relief = DGG.RAISED,
                                       state = DGG.NORMAL,
                                       ...
                                       text_pos = (0.1, 0.03),
                                       textMayChange = 1, pos = (0.18, 0, 0.05),
                                       command = self.table.playerIsReady,
                                       extraArgs = []
                                       )
        self.exitButton = DirectButton(parent = self.menu,
                                       relief = DGG.RAISED,
                                       text = 'X',
                                       text_align = TextNode.ACenter,
                                       text_scale = 0.04,
    ...
    def loadDie(self, dienum):
        self.dice[dienum] = loader.loadModelCopy('models/props/dice')
