...
class PokerStatusPanel(DirectFrame):
    ...
    def __init__(self, maxHandCards):
        ...
        self.anteLabel = DirectLabel(parent = self.dealerButton, relief = None, text = '', text_align = TextNode.ACenter, text_scale = 0.8, pos = (0, 0, -0.3), text_fg = (0, 0, 0, 1))
...
class PokerTableGUI(DirectFrame, TableGUI):
    ...
    def __init__(self, table, maxCommunityCards, maxHandCards):
        ...
        self.disableReason = DirectLabel(parent = self.menu, text = '', text_align = TextNode.ACenter, text_scale = 0.04, pos = (0, 0, 0.175), text_fg = PiratesGuiGlobals.TextFG2, text_shadow = PiratesGuiGlobals.TextShadow, textMayChange = 1)
        ...
        self.buttonArray = self.buttonArray + [
            button]
        x = x + x_increment
        self.potSizeLabel = DirectLabel(parent = self, relief = None, text = '', text_align = TextNode.ACenter, text_scale = 0.05, pos = (-0.15, 0.0, 0.17), text_fg = (1, 0.9, 0.6, 1), text_shadow = (0, 0, 0, 1))
