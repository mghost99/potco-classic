...
class BlackjackStatusPanel(DirectFrame, SplitBase):
    ...
    def __init__(self, maxHandCards):
        ...
        self.actionLabel = DirectLabel(parent = self, relief = None, text = '', text_align = TextNode.ACenter, text_scale = 0.04, pos = (0, 0, 0.15), text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1))
        self.handNameLabel = DirectLabel(parent = self, relief = None, text = '', text_align = TextNode.ACenter, text_scale = 0.04, pos = (0, 0, -0.13), text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1))
        self.splitLabel = DirectLabel(parent = self, relief = None, text = '', text_align = TextNode.ACenter, text_scale = 0.04, pos = (0, 0, -0.17), text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1))
        self.handsLabel = DirectLabel(parent = self, relief = None, text = '', text_align = TextNode.ACenter, text_scale = 0.04, pos = (0, 0, -0.21), text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1))
...
class BlackjackTableGUI(DirectFrame, TableGUI, SplitBase):
    HandPos = (Vec3(0, 0, 0.4), Vec3(0.38, 0, 0.33), Vec3(0.65, 0, 0.1), Vec3(0.45, 0, -0.26), Vec3(0, 0, -0.3), Vec3(-0.45, 0, -0.26), Vec3(-0.65, 0, 0.1), Vec3(-0.38, 0, 0.33))
    ...
    def __init__(self, table):
        ...
        self.moneyDisplay = DirectLabel(parent = self.menu, relief = None, pos = (-0.3 + x_increment / 2.0, 0, 0.075), geom = goldCoin, geom_scale = (scale, scale, scale), geom_pos = (0, 0, 0), text = '%s' % currentMoney, text_align = TextNode.ALeft, text_scale = 0.04, text_pos = (0.05, -0.01), text_fg = PiratesGuiGlobals.TextFG1, text_shadow = PiratesGuiGlobals.TextShadow, textMayChange = 1, scale = 1.1)
        ...
        this.sfxArray = this.sfxArray + [
            loader.loadSfx('audio/sfx_cards_hit.mp3')]
    ...
    def cancelSelection(self, value):
    ...
    def createSplitDisplay(self, seat, allHands, parent):
        ...
        if total_hands > 1:
            ...
            for h in range(total_hands):
                ...
                label = DirectLabel(parent = parent, relief = None, text = '', text_align = TextNode.ACenter, text_scale = 0.04, pos = (x, 0.0, y), text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1))
