...
class Knife(DirectFrame):
    SOUNDS = {
        'miss': 'src/minigame/peg/m_match_drums.mp3',
        'hit': 'src/minigame/peg/AA_slice_only.mp3'}
    POSHPR = {
        'neutral': (Vec3(0.12, 0, 1.25), Vec3(0.0, 0.0, 10.0)),
        'in': (Vec3(0.03, 0, 1.13), Vec3(0.0, 0.0, 0.0)),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.shadow = DirectFrame(parent = self.shadowTurner, relief = None, geom = model.find('**/BH_shadow'), scale = 0.075, pos = (0.0, 0.0, 0.8))
...
class BishopsHandGame(DirectFrame, FSM.FSM):
    ...
    def __init__(self, gameCallback, seatPos):
        ...
        self.faces = [ FaceSpot(0, parent = self.gameInterface, relief = None, pos = BishopsHandGlobals.FACE_SPOT_POS[p], scale = 0.333) for p in list(BishopsHandGlobals.FACE_SPOT_POS.keys())[1:] ]
        ...
        self.menu.hide()
        self.joinButton = DirectButton(parent = self.menu, relief = DGG.RAISED, state = DGG.NORMAL, text = 'Join: 2 Gold', text_align = TextNode.ACenter, text_scale = PiratesGuiGlobals.TextScaleLarge, text_fg = PiratesGuiGlobals.TextFG2, frameColor = PiratesGuiGlobals.ButtonColor1, frameSize = (0, 0.4, 0, 0.08), borderWidth = PiratesGuiGlobals.BorderWidth, text_pos = (0.2, 0.03), textMayChange = 1, pos = (0.05, 0, 0.1), command = self.gameCallback, extraArgs = [
        ...
        self.exitButton = DirectButton(parent = self.menu, relief = DGG.RAISED, text = 'X', text_align = TextNode.ACenter, text_scale = 0.04, text_pos = (0.02, 0.01), text_fg = (0.75, 0.75, 0.75, 1), text_shadow = PiratesGuiGlobals.TextShadow, textMayChange = 0, frameColor = PiratesGuiGlobals.ButtonColor1, borderWidth = PiratesGuiGlobals.BorderWidthSmall, frameSize = (0, 0.04, 0, 0.04), pos = (0.75 - 0.01 - 0.04, 0, 0.01), command = self.gameCallback, extraArgs = [
            -1])
        self.roundLabel = DirectLabel(parent = self, relief = None, text = '', text_align = TextNode.ALeft, text_scale = 0.06, pos = (-0.1, 0, 0.45), text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1), textMayChange = 1, text_font = PiratesGlobals.getPirateOutlineFont())
        self.potSizeLabel = DirectLabel(parent = self, relief = None, text_align = TextNode.ALeft, text_scale = 0.08, pos = (-0.1, 0, 0.5), text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1), textMayChange = 1, text_font = PiratesGlobals.getPirateOutlineFont())
        ...
        self.timerLabel = DirectLabel(parent = self, relief = None, text = '', pos = (1, 0, 0.55), scale = 0.1, text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1), textMayChange = 1, text_font = PiratesGlobals.getPirateOutlineFont())
